...
WebUI.doubleClick(findTestObject('Object Repository/Page_CURA Healthcare Service/strong_CURA Healthcare Service'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/strong_CURA Healthcare Service'))

WebUI.doubleClick(findTestObject('Object Repository/Page_CURA Healthcare Service/p_Atlanta 550 Pharr Road NE Suite 525Atlant_8f4c85'))
...
WebUI.doubleClick(findTestObject('Object Repository/Page_CURA Healthcare Service/p_Copyright  CURA Healthcare Service 2024'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/p_Copyright  CURA Healthcare Service 2024'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/div_CURA Healthcare Service                _bba294_1'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/ul_infokatalon.com_list-inline'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/html_CURA Healthcare Service               _2b5fdb'))
